...
const animation = 'circleDash 500ms 600ms cubic-bezier(0.33, 1, 0.68, 1) forwards';
...
const CircleIcon: FC<Props> = ({ visible }) => {
  ...
  return (
    <SVG xmlns="http://www.w3.org/2000/svg" viewBox="0 0 193 95" fill="none">
      <path
        ref={ref}
        style={{ strokeDashoffset: length, strokeDasharray: length, animation: visible ? animation : '' }}
        ...
        stroke="#57B0F8" strokeWidth="5" strokeLinecap="round"/>
    </SVG>
  );
}
